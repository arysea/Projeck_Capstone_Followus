                        ...
                        <div class="col-md-4" style="margin-bottom: 30px;">
                            <div class="card" style="border:1px solid #ececec; border-radius: 10px; overflow:hidden;">
                                ...
                                <div style="padding: 15px; display: flex; flex-direction: column; gap: 12px;">
                                    <h4 style="font-size:22px; margin-bottom:0; min-height:56px; line-height:1.2;"><?= htmlspecialchars($name) ?></h4>
                                    <div style="font-size:18px; color:#d10024; font-weight:700; margin-bottom:0;">Rp <?= number_format($price, 0, ',', '.') ?></div>
                                    <div style="font-size:16px; color:#7e7e7e; margin-bottom:0;">Ukuran: <?= htmlspecialchars($size) ?></div>
                                    <button type="button" class="btn btn-primary mt-auto" data-toggle="modal" data-target="#productModal<?= $item['id'] ?>">Lihat Detail</button>
                                </div>
                            </div>
                        </div>

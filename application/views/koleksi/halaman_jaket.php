			...
			">
				...
				<div class="row" style="margin-top:50px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						...
						<img src="<?=  base_url("template_home") ?>/img/jaket/stich_red.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL </label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Hoodie Stich Red</label>
                            <br>
                            <label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 329.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/jaket/hoodie_grey.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL </label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Hoodie Combine Grey</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 329.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/jaket/cord_pink.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Cord Pink Jacket</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 349.000</label>
						</div>
					</div>

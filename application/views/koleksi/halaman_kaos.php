			...
			">
				...
				<div class="row" style="margin-top:50px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						...
						<img src="<?=  base_url("template_home") ?>/img/kaos/boxy_dreams.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >T-shirt Boxy HAVE DREAMS</label>
                            <br>
                            <label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_blessed.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-shirt Boxy BLESSED</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/boxy_property.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-shirt  Boxy Property</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
				...
				<div class="row" style="margin-top:15px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_fruit.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-shirt Boxy FRUIT</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_ease.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-shirt Boxy EASE</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_camera.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-shirt Reguler Camera </label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_lovers.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-Shirt Reguler Lovers</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_times.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" > T-shirt Reguler Times</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kaos/kaos_bad.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >M L XL XXL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >T-shirt Reguler Future</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 149.000</label>
						</div>
					</div>

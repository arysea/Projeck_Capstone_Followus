			...
			">
				...
				<div class="row" style="margin-top:50px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						...
						<img src="<?=  base_url("template_home") ?>/img/celana/celana_hitam.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >S M L XL </label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Corduroy Baggy Pants</label>
                            <br>
                            <label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 299.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/celana/celana_cream.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >S M L XL </label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Corduroy Baggy Pants </label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 299.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/celana/celana_army.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; color:#7E7E7E; cursor:pointer;" >S M L XL</label>
							<br>
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Corduroy Baggy Pants </label>

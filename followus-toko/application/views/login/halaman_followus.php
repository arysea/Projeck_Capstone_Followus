...
<div class="container" style="padding:60px 0; min-height:600px;">
  ...
  Follow Us adalah brand local asal Bogor dibangun sejak 2015 yang memproduksi seperi kaos,
 jaket, hoodie, topi, tas, beanie, celana, dll. Follow Us juga sudah bersertifikat merek yang disahkan pada tahun 2022
					...
					<div class="row">
						...
						<div class="col-md-4 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
                                    <a href="<?= base_url('index.php/followus/halaman_followus') ?>" style="text-decoration:none; color:black;"></a>
									<li><a href="#" style="color:#fff">Perusahaan</a></li>
                                    <a href="<?= base_url('index.php/syarat/halaman_syarat') ?>" style="text-decoration:none; color:black;"></a>

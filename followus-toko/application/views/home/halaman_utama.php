	...
	<body>
		...
		<div class="section">
			...
			<p style="font-size:20px; font-weight:400; text-align:justify">
				Dirancang dengan siluet klasik dan sentuhan streetwear, topi ini memberikan kenyamanan maksimal dengan tampilan yang effortless. Cocok digunakan untuk daily wear maupun sebagai statement dalam outfit.
			</p>
			...
			<div class="row" style="margin-top:40px; justify-content: center; align-items: center;" >
				<img src="<?=  base_url("template_home") ?>/img/barang/img_collection1.png" style="display: block;
					margin-left: auto;
					margin-right: auto;" width="97%"  alt="">
			</div>
			<div style="display: flex; justify-content: right; align-items: right; margin-top:10px; text-decoration: underline;" >
				...
				<!-- row -->
				<label  style="font-size:20px; font-weight:400; margin-top:40px">Barang Baru</label>
				<div style="display: flex; gap: 20px;">
					<!-- shop -->
					<div style="flex: 1;">
						<div class="">
							<div class="shop-img">
								<img src="<?=  base_url("template_home") ?>/img/barang/barang_baru_1.png" style="width: 100%;" alt="">
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div style="flex: 1;">
						<div class="">
							<div class="shop-img">
								<img src="<?=  base_url("template_home") ?>/img/barang/barang_baru_2.png" style="width: 100%;" alt="">
							</div>
						</div>
					</div>
					<!-- /shop -->
				...
				<div class="row" style="margin-top:25px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/barang/barang_1_dijual.png" style="width: 100%;" alt="">
						<div style="margin-top: 15px;">
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Kemeja Work Shirt</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp 249.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/barang/barang_2_dijual.png" style="width: 100%;" alt="">
						<div style="margin-top: 15px;">
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Topi Windbreaker</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp 149.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/barang/barang_3_dijual.png" style="width: 100%;" alt="">
						<div style="margin-top: 15px;">
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Kaos Boxy Fruit</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp 149.000</label>
						</div>
					</div>

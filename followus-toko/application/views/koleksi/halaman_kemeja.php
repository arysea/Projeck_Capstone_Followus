			...
			">
				...
				<div class="row" style="margin-top:50px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<a href="<?= base_url('index.php/koleksi/halaman_kemeja') ?>"style="text-decoration:none; color:black;">
						<img src="<?=  base_url("template_home") ?>/img/kemeja/flanel_black.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" > Pata Black Flanel </label>
                            <br>
                            <label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 249.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kemeja/flanel_billy.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Billy Navy Flanel </label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 249.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kemeja/kemeja_inline.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Work Shirt Boxy in Line</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 249.000</label>
						</div>
					</div>
				...
				<div class="row" style="margin-top:15px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kemeja/flanel_brown.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Moon Brown Flanel</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 249.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kemeja/polka_1.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" > Shirt Polka</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 210.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/kemeja/collar_leopard.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Shirt Collar Cheetah</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 249.000</label>
						</div>
					</div>

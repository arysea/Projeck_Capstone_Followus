			...
			">
				...
				<div class="row" style="margin-top:50px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						...
						<img src="<?=  base_url("template_home") ?>/img/tas/bag_milka.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Waistbag Milka </label>
                            <br>
                            <label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 100.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/tas/bag_biru.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Waistbag Blue Smile </label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 100.000</label>
						</div>
					</div>
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/tas/bag_merah.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Waistbag Milky</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 100.000</label>
						</div>
					</div>
				...
				<div class="row" style="margin-top:15px" >
					<div class="col-md-4 hover-timbul" style="cursor:pointer; ">
						<img src="<?=  base_url("template_home") ?>/img/tas/bag_happen.png" style="width: 100%;" alt="">
						<div style="margin-top: 10px;">
							<label for="" style="font-size:24px; font-weight:500; cursor:pointer;" >Totebag Happen Dept</label>
							<br>
							<label for="" style="font-size:24px; font-weight:400; cursor:pointer;" >Rp. 100.000</label>
						</div>
					</div>
